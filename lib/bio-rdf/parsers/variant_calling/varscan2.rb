    ...
    module Varscan2
      module ProcessSomatic
        def ProcessSomatic::parse(id,string)
          ...
          [:pos,:ref_reads_in_normal,:variant_reads_in_normal,:ref_reads_in_tumor,:variant_reads_in_tumor,:tumor_reads1_plus,:tumor_reads1_minus,:tumor_reads2_plus,:tumor_reads2_minus,:normal_reads1_plus,:normal_reads1_minus,:normal_reads2_plus,:normal_reads2_minus].each { |k| rec[k] = rec[k].to_i }
